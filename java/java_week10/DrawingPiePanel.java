...
public void paint(Graphics g) {
		...
		g.drawString(" IT공학전공: 노랑", 300, 150);//범례(legend)
		g.drawString(" 경영학부: 빨강", 300, 170);//범례(legend)
		g.drawString(" 수학과: 파랑", 300, 190);//범례(legend)
		g.drawString(" 미디어학부: 초록", 300, 210);//범례(legend)
	}
	//숫자값 입력받는 메소드
